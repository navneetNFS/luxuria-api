...
// Image Related Task
product_route.post('/product-thumb', upload.single('thumb') , authentication , authorizeRoles("admin") , isVerified(true) , product_ctrl.thumbImageUpload)
product_route.post('/product-images', upload.single('images') , authentication , authorizeRoles("admin") , isVerified(true) , product_ctrl.imagesUpload)
product_route.delete('/delete-product-image/:imageName', authentication , authorizeRoles("admin") , isVerified(true) , product_ctrl.deleteProductImage)
