...
order_routes.delete('/delete-order/:orderId' , authentication , authorizeRoles("admin","super-admin") , isVerified(true), order_ctrl.deleteOrder)

order_routes.get('/', authentication , authorizeRoles("admin","super-admin") , isVerified(true) , order_ctrl.getOrders)
